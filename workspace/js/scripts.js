/*
Image gallery - Code by Zsolt Kiraly
v1.0.2 - 2019-05-08
*/
                ...
                bodyImage.addEventListener('touchend', function(e) {
                    ...
                    if(element.length > 1) {
                        ...
                        if(e.touches.length == 0) {
                            ...
                            var touchobj = e.changedTouches[0];
                            distTouch = parseInt(touchobj.clientX) - startxTouch;
